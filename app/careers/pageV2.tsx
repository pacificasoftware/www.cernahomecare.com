...
export default function CareersPage() {
    ...
    async function loadJobsNearZip() {
        ...
        try {
            ...
            /*    alert(`FETCH FAILED: ${fetchError?.message || fetchError}`);*/
            ...
            if (!response.ok) {
                ...
                setJobsError(
                    `We do not currently have openings within ${radiusMiles} miles of ${trimmedZip}. Please try another ZIP code or check back soon.`
                );
            ...
            if (jobs.length === 0) {
                setJobsError(
                    `We do not currently have openings within ${radiusMiles} miles of ${zipCode}. Please try another ZIP code or check back soon.`
                );
                        ...
                        <div className="mt-8 w-full max-w-[410px] rounded-xl bg-white/20 px-5 pb-3 pt-3 shadow-xl ring-1 ring-white/10 backdrop-blur-sm">
                            ...
                            <div className="mt-3">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-[11px] font-semibold text-white/75">50</span>
                                    ...
                                    <input
                                        ...
                                        className="h-1 w-full cursor-pointer appearance-none rounded-full bg-white/60 accent-[#DD8500]"
                                        aria-label="Search radius in miles"
                                    />

                                    <span className="text-[11px] font-semibold text-white/75">500</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-2 rounded-3xl border-2 border-[#00456B]/20 bg-white p-6 shadow-xl">
                                ...
                                >
                                    ...
                                    {["CA", "CALIFORNIA"].includes(
                                        (selectedPopupJob.locationState ?? "").trim().toUpperCase()
                                    ) && (
                                            <div className="grid gap-2">
                                                <span className="text-sm font-bold text-slate-700">
                                                    Do you currently have a HCA Per ID?
